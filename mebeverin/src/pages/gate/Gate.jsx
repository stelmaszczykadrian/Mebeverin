        ...
        <>
            <div className="gate-container">
                ...
                <div className="gate-subtitle">
                    ...
                    <span className="gate-subtitle-primary">edukacyjnego</span><span
                    className="gate-subtitle-secondary"> dla lekarzy!</span>
                </div>
                ...
                <div className="gate-privacy-policy">
                    ...
                    <div className="gate-privacy-policy-container">
                        <div className="privacy-policy-description-primary">
                            ...
                            prowadzonego
                            przez właściwą okręgową radę lekarską, oraz nie zostałem zawieszony w prawie wykonywania
                            zawodu
                            lekarza ani ograniczony w wykonywaniu określonych czynności medycznych. Jestem osobą
                            uprawnioną
                            do
                            otrzymywania specjalistycznych informacji medycznych zgodnie z ustawą Prawo farmaceutyczne.
                            Chcę
                            zapoznać się z treścią serwisu.
                        </div>
                        <div className="privacy-policy-description-secondary">
                            Niniejszy serwis skierowany jest do lekarzy. Ze względu na wymogi ustawy z dnia 6 września
                            2001
                            r.
                            Prawo farmaceutyczne, dostęp do treści zawartych w serwisie, materiałów i informacji,
                            możliwy
                            jest
                            wyłącznie dla osób uprawnionych do otrzymywania specjalistycznych informacji medycznych oraz
                            reklamy
                            produktów leczniczych. Jeśli nie jesteś osobą uprawnioną treści prezentowane w serwisie nie
                            są
